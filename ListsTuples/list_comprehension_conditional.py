...
# Note: these are powerful, but may be complex and make your code difficult to read.  Therefore, use sparingly.  But understand it so you can read other programmers' code.